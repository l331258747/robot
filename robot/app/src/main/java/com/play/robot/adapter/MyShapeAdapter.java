...
public class MyShapeAdapter extends RecyclerView.Adapter<MyShapeAdapter.ViewHolder> {

    Context mContext;
    List<String> datas;

    public MyShapeAdapter(Context context, List<String> datas) {
        mContext = context;
        this.datas = datas;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(mContext).inflate(R.layout.item_shape, parent, false);
